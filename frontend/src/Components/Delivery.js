...
import { Form, Input, Icon, Button, Card, Modal } from "antd";
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields(async (err, values) => {
      if (!err) {
        ...
        let rawResponse = await fetch("http://localhost:9000/Delivery", {
          method: "POST",
          headers: {
                    ...
                    <Form onSubmit={this.handleSubmit}>
                      ...
                      <Form.Item label="COMPANY">
                        {getFieldDecorator("company", {
                          ...
                          <Input placeholder="Zomato/Flipcart/Amazon......" />
                        )}
                      </Form.Item>
                      <Form.Item>
                        <Button
...
const WrappedDemo = Form.create({ name: "validate_other" })(delivery);
